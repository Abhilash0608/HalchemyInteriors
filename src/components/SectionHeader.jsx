    ...
    return (
        <div className="flex flex-col space-y-2 justify-start items-start p-6 flex-1">
            ...
            <motion.h1
                ...
                viewport={{ once: true, amount: 0.8 }} // Trigger once, when 50% in view
            ...
            <div className="flex w-full justify-start items-center space-x-6">
                <motion.h1 className="underline"    initial={{ x: -100, opacity: 0 }} 
                whileInView={{ x: 0, opacity: 1 }}
                viewport={{ once: true, amount: 0.8 }} 
                transition={{ duration: 1, ease: "easeOut" }} ></motion.h1>
